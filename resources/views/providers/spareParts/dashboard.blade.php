                ...
                <div class="part-card shadow-sm h-100">
                    ...
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('spareparts.edit', $part->id) }}"
                           class="btn  w-50"
                           style="border:1px solid #163155;border-radius:18px;">
                           <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-pencil-square me-1" viewBox="0 0 16 16">
