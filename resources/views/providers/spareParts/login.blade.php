...
<h5 class="text-center">SpareParts Dealer Login</h5>
        ...
        <div class="sign-up">
            Don't have an account? <a href="{{ route('providers.spareparts.register') }}">Create One</a>
        </div>
    </div>
</div>
...
function sendOTP() {
    ...
    const devPhone = "+971577777777"; // رقمك الشخصي بالصيغة النهائية
...
function handleVerifiedFirebaseUser(user) {
    ...
    $.ajax({
        url: "/verify-login-token-spareparts",
        method: "POST",
