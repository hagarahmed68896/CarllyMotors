...
<div id="car-create-page">
    <div id="container">
        <h2 class="mb-4 mt-2 text-center fw-bold" style="color:#163155;">Edit Your Car</h2>
        <div class="card">
     <!-- Car Edit Form -->
...
<div class="col-12">
  ...
  <div class="input-group feature-input-group shadow-sm rounded-3 overflow-hidden" style="height: 38px;">
    ...
    <button type="button" id="addFeatureBtn"
      ...
      style="background-color: #f8f9fa; color: #163155; border-left: 1px solid #ced4da;">
...
document.getElementById('carForm').addEventListener('submit', function(e) {
 ...
 fetch("{{ route('provider.cars.update', $car->id) }}", {
    method: "POST",
    headers: {
