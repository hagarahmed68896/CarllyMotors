...
<div id="car-create-page">
    <div id="container">
        <h2 class="mb-4 mt-2 text-center fw-bold" style="color:#163155;">Add Your Car</h2>
        <div class="card">
            <!-- Car Form -->
...
<input type="hidden" name="car_type" value="{{ $type }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group feature-input-group shadow-sm rounded-3 overflow-hidden"
                            ...
                            <button type="button" id="addFeatureBtn"
                                ...
                                style="background-color: #f8f9fa; color: #163155; border-left: 1px solid #ced4da; border-top-right-radius: 0; border-bottom-right-radius: 0;">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <button type="button" style="background-color: #163155; color: white;"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    brandSelect.addEventListener('change', updateName);
        ...
        <input 
            ...
            value="{{ 
                old(
                    'contact_number',
                    isset($car) 
                        ? str_replace('+971', '', $car->contact_number)
                        : str_replace('+971', '', auth()->user()->phone ?? '')
                ) 
            }}"
        >
    </div>
        ...
        <input 
            ...
            value="{{ 
                old(
                    'wa_number',
                    isset($car) 
                        ? str_replace('+971', '', $car->wa_number)
                        : str_replace('+971', '', auth()->user()->whatsapp ?? auth()->user()->phone ?? '')
                ) 
            }}"
        >
    </div>
...
/* نصنع الـ radius للجهة الخارجية */
.input-group .input-group-text:first-child {
    border-top-left-radius: 10px;
    border-bottom-left-radius: 10px;
    border-right: none; /* إزالة الحد بين span و input */
}

.input-group .form-control {
    border-left: none; /* إزالة الحد الأيسر من input */
