...
<h5 class="text-center">Workshop Login</h5>
        ...
        <div class="sign-up">
            Don't have an account? <a href="{{ route('providers.workshops.register') }}">Create One</a>
        </div>
    </div>
</div>
...
function sendOTP() {
    ...
    const devPhone = "+971111111111"; // رقمك الشخصي بالصيغة النهائية
...
function handleVerifiedFirebaseUser(user) {
    ...
    $.ajax({
        url: "/verify-login-token-workshop",
        method: "POST",
